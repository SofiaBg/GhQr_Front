...
@Component({
  selector: 'app-rejected-bulk-merchant',
  templateUrl: './rejected-bulk-merchant.component.html',
  styleUrls: ['./rejected-bulk-merchant.component.css']
})
export class RejectedBulkMerchantComponent implements OnInit {
  ...
  ngOnInit() {
    this.getAllRejectedBulkMerchant();
  }
  ...
  getAllRejectedBulkMerchant() {
    ...
    this.gipService.getAllRejectedBulkMerchant().subscribe((data) => {
