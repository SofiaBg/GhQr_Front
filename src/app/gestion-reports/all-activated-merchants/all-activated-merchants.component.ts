...
@Component({
  selector: 'app-all-activated-merchants',
  templateUrl: './all-activated-merchants.component.html',
  styleUrls: ['./all-activated-merchants.component.css']
})
export class AllActivatedMerchantsComponent extends BaseComponent implements OnInit {
  ...
  getAllActivatedMerchantsReports(){

    this.checkFields();
    this.service.getAllActivatedMerchantsReports(this.dateFrom,this.dateTo).subscribe(resp => {
