...
@Component({
  selector: 'app-all-rejected-bulk-merchants-by-branch',
  templateUrl: './all-rejected-bulk-merchants-by-branch.component.html',
  styleUrls: ['./all-rejected-bulk-merchants-by-branch.component.css']
})
export class AllRejectedBulkMerchantsByBranchComponent extends BaseComponent implements OnInit {
  ...
  getRejectedBulkMerchantReportsByBranchpdf() {
    console.log('Generate Pdf for All Merchants')
    console.log('All merchants', this.dateFrom);
    console.log('All merchants', this.dateTo);

    this.service.getAllRejectedBulkMerchantReportsByBranchPdf(this.dateFrom, this.dateTo,this.branchInput).subscribe(data => {
  ...
  report() {
    ...
    console.log(this.dateTo)
      ...
      console.log(this.dateFrom)
      console.log(this.dateTo)
      this.getRejectedBulkMerchantReportsByBranchpdf();    
  }
  ...
  getAllRejectedBulkMerchantReportsByBranch(){

    this.checkFields();
    this.service.getAllRejectedBulkMerchantReportByBranch(this.dateFrom,this.dateTo).subscribe(resp => {
