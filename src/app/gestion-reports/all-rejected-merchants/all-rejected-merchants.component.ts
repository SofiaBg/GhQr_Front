...
@Component({
  selector: 'app-all-rejected-merchants',
  templateUrl: './all-rejected-merchants.component.html',
  styleUrls: ['./all-rejected-merchants.component.css']
})
export class AllRejectedMerchantsComponent extends BaseComponent implements OnInit {
  ...
  allMerchantsPdf() {
    ...
    this.service.allRejectedBulkMerchant(this.dateFrom, this.dateTo).subscribe(data => {
  ...
  getAllRejectedBulkMerchant(){

    this.checkFields();
    this.service.getAllRejectedBulkMerchants(this.dateFrom,this.dateTo).subscribe(resp => {
