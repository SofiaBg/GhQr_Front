...
@Component({
  selector: 'app-all-rejected-bulk-merchants-a-by-branch',
  templateUrl: './all-rejected-bulk-merchants-a-by-branch.component.html',
  styleUrls: ['./all-rejected-bulk-merchants-a-by-branch.component.css']
})
export class AllRejectedBulkMerchantsAByBranchComponent extends BaseComponent implements OnInit {
 ...
 if (this.dateFrom == null && this.dateTo == null) {
  ...
  getAllRejectedBulkMerchantReportsByBranch(){
    ...
    this.checkFields();
    this.service.getAllRejectedBulkMerchantReportsByBranch(this.dateFrom,this.dateTo,this.branchInput).subscribe(resp => {
