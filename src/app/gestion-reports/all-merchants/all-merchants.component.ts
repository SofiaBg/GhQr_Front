...
@Component({
  ...
  styleUrls: ['./all-merchants.component.css']
})
export class AllMerchantsComponent extends BaseComponent implements OnInit {
  ...
  getAllMerchantsReports() {

    this.checkFields();
    this.service.getAllMerchantsReport(this.dateFrom, this.dateTo).subscribe(resp => {
