...
@Component({
  selector: 'app-all-validated-bulk-merchants-by-branch',
  templateUrl: './all-validated-bulk-merchants-by-branch.component.html',
  styleUrls: ['./all-validated-bulk-merchants-by-branch.component.css']
})
export class AllValidatedBulkMerchantsByBranchComponent extends BaseComponent implements OnInit {
  ...
  /* SAFIA 08.10.2021 */
  getAllValidatedBulkMerchantReportsByBranchpdf() {
    console.log('Generate Pdf for All Merchants')
    console.log('All merchants', this.dateFrom);
    console.log('All merchants', this.dateTo);

    this.service.getAllValidatedBulkMerchantReportsByBranchPdf(this.dateFrom, this.dateTo).subscribe(data => {
 ...
 if (this.dateFrom == null && this.dateTo == null) {
  ...
  report() {
    ...
    console.log(this.dateTo)
      ...
      console.log(this.dateFrom)
      console.log(this.dateTo)
      this.getAllValidatedBulkMerchantReportsByBranchpdf();    
  }
  ...
  getAllValidatedBulkMerchantReportsByBranch(){
    ...
    this.checkFields();
    this.service.getAllValidatedBulkMerchantReportByBranch(this.dateFrom,this.dateTo).subscribe(resp => {
