...
@Component({
  selector: 'app-all-bulk-merchants',
  templateUrl: './all-bulk-merchants.component.html',
  styleUrls: ['./all-bulk-merchants.component.css']
})
export class AllBulkMerchantsComponent extends BaseComponent implements OnInit {
  ...
  getAllBulkMerchantsReports(){

    this.checkFields();
    this.service.getAllBulkMerchantsReports(this.dateFrom,this.dateTo).subscribe(resp => {
