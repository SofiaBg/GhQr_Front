...
@Component({
  selector: 'app-all-validated-merchants',
  templateUrl: './all-validated-merchants.component.html',
  styleUrls: ['./all-validated-merchants.component.css']
})
export class AllValidatedMerchantsComponent extends BaseComponent implements OnInit {
  ...
  allMerchantsPdf() {
    ...
    this.service.allValdiatedMerchantPdf(this.dateFrom, this.dateTo).subscribe(data => {
  ...
  getAllValidatedBulkMerchantReport(){

    this.checkFields();
    this.service.getAllValidatedBulkMerchantReports(this.dateFrom,this.dateTo).subscribe(resp => {
